...
1. A single map which contains the landmarks single initial location (via GPS). This is only in the beginning with alot of uncertainty.
2. Noisy landmark observations at each timestamp once the vehicle is moving.
...
The basic algorithm is based on the flow below:

![Algorithm](images/img02.png)
...
**For 100 particles**
![output](images/img100.png)

**For 150 particles**
![output](images/img150.png)
...
When you run the project you see the following: 
```
    $ ./run.sh

...
MPC::~MPC()
{
  // Clear the vectors used for plotting
...
/*
The function Solve is mostly inspired by the assignments presented in the lectures.
The constraints and the solution vector calculation is inspired by the
Quiz mpc_to_line.
I have also used the plot concept from it, to see how the values such as
cte, delta and velocity varies according to the values of N and dt.
*/
